...
Here we propose to solve the following non-linear academic problem of
minimization of a functional

.. math:: J(u) = \int_\Omega \frac{1}{2} f(|\nabla u|^2) - u*b

\ where :math:`u` is function of :math:`H^1_0(\Omega)` and :math:`f`
defined by
...
Now, we solve the Euler problem $ :raw-latex:`\nabla `J (u) = 0$ with
Newton-Raphson algorithm, that is,
